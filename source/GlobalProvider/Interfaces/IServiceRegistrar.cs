...
namespace Mini.GlobalProvider
{
    public interface IServiceRegistrar
    {
        ...
        IProvider RegisterService<TService>(TService serviceInstance)
        ...
        //    params object[] args) where T : IServiceConsumer;
        ...
        /// <returns>True if the service was successfully unregistered, false otherwise.</returns>
        bool UnregisterService<T>(T serviceInstance) where T : IService;
